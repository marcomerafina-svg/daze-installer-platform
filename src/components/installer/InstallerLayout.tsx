  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <main className="flex-1 pt-16 lg:pt-0 lg:mr-72 min-h-screen px-4 sm:px-6 lg:px-8 py-6 lg:py-8 overflow-auto">
          {children}
        </main>
        ...
        <aside className={`
          ...
          w-72 h-screen bg-gradient-to-br from-teal-500 via-teal-600 to-teal-700
          shadow-strong

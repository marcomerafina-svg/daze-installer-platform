...
export default function Rewards() {
  ...
  const loadData = async () => {
    ...
    try {
      const [rewardsRes, tiersRes, transactionsRes] = await Promise.all([
        supabase
  ...
  return (
    <InstallerLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Il Mio Sistema Rewards</h1>
        <p className="text-gray-600">Traccia i tuoi progressi e sblocca premi esclusivi</p>
      </div>

  ...
  return (
    <InstallerLayout>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Ecco le tue lead più recenti</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-sm border border-cool-gray-300 p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-black/70 text-sm font-medium">Lead Totali</h3>
            <div className="w-10 h-10 bg-cool-gray rounded-lg flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-cool-gray-300 p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-black/70 text-sm font-medium">Lead Attive</h3>
            <div className="w-10 h-10 bg-sky/40 rounded-lg flex items-center justify-center">
              <span className="text-2xl font-bold text-reflex-blue-900">{stats.active}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-cool-gray-300 p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-black/70 text-sm font-medium">Lead Vinte</h3>
            <div className="w-10 h-10 bg-forest/40 rounded-lg flex items-center justify-center">
              <span className="text-2xl font-bold text-forest-dark">{stats.won}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-cool-gray-300 p-6">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-black/70 text-sm font-medium">Conversion Rate</h3>
            <div className="w-14 h-10 bg-honey/40 rounded-lg flex items-center justify-center">
              <span className="text-xl font-bold text-honey-dark">{stats.conversionRate}%</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {newLeads.some(lead => !lead.assignment.confirmed_by_installer) && (
        <div className="bg-gradient-to-br from-salmon-light to-salmon/40 rounded-xl p-6 mb-6 border-2 border-salmon shadow-md">
          <div className="flex items-start gap-4">
            <div className="bg-salmon p-3 rounded-lg animate-pulse shadow-lg">
      ...
      <div className="bg-gradient-to-br from-sky-light to-sky/50 rounded-xl p-6 mb-8 border border-sky-dark shadow-md">
        <div className="flex items-start gap-4">
          <div className="bg-gradient-to-br from-reflex-blue to-reflex-blue-700 p-3 rounded-lg shadow-lg">
      ...
      {newLeads.length > 0 && (
        <div className="grid gap-4">
          {newLeads.map((lead) => (
            <div
              key={lead.id}
              className="bg-white rounded-xl shadow-sm border-2 border-sky-dark p-6 hover:shadow-lg hover:border-reflex-blue transition-all relative"
            >
              <div className="absolute top-4 right-4 flex gap-2">
                {!lead.assignment.is_viewed && (
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-salmon text-white animate-pulse shadow-md">
                    NUOVO
                  </span>
                )}
                {!lead.assignment.confirmed_by_installer && (
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-honey text-white shadow-md">
                    DA CONFERMARE
                  </span>
                )}
              </div>
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-3">
                    ...
                    {lead.email && (
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`mailto:${lead.email}`} className="hover:text-reflex-blue">
                          {lead.email}
                        </a>
                      </div>
                    )}
              ...
              <div className="flex gap-3">
                <Link
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-reflex-blue to-reflex-blue-600 text-white px-4 py-3 rounded-lg font-medium hover:shadow-xl hover:scale-[1.02] transition-all"
                >
                  Visualizza Dettagli
      ...
      <div className="mt-8 text-center">
        <Link
          ...
          className="inline-flex items-center gap-2 text-reflex-blue-600 hover:text-reflex-blue font-medium"
        >

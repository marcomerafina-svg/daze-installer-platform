      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          {lead.status === 'Nuova' && assignment && !assignment.confirmed_by_installer && (
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-300 shadow-md">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    disabled={confirming}
                    className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
            ...
            <div className="grid gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${lead.phone}`} className="text-lg font-medium text-[#4a5fc1] hover:text-[#223aa3]">
                    {lead.phone}
                  </a>
                </div>
              </div>
              ...
              {lead.email && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${lead.email}`} className="text-lg font-medium text-[#4a5fc1] hover:text-[#223aa3]">
                      {lead.email}
                    </a>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Cambia Stato</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              {history.length === 0 ? (
                <p className="text-gray-500 text-sm text-center py-4">Nessuno storico</p>
              ) : (
                history.map((h) => (

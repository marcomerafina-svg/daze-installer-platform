  ...
  return (
    <AdminLayout>
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-black/70">Panoramica generale della piattaforma</p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-3 sm:mb-4">
                <div className={`bg-gradient-to-br ${card.color} p-2 sm:p-3 rounded-lg`}>
                  <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
              </div>
              <h3 className="text-black/70 text-xs sm:text-sm font-medium mb-1">{card.title}</h3>
              <p className="text-2xl sm:text-3xl font-bold text-black mb-1">{card.value}</p>
              <p className="text-xs sm:text-sm text-black/60">{card.subtitle}</p>
            </div>
          );
        })}
      </div>
